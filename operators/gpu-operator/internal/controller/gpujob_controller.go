...
// +kubebuilder:rbac:groups=gpu.yourstartup.com,resources=gpujobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=gpu.yourstartup.com,resources=gpujobs/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=gpu.yourstartup.com,resources=gpujobs/finalizers,verbs=update
